...
setup lights' window = do
    ...
    -- TODO: This will throw an exception if we don't have that element...
...
{-
      <div class="thumbnails">
        <div class="thumbnail" style="opacity: 1.0;">
          ...
          <div class="small text-center">Brightness</div>
          <div class="progress">
...
{-
    ...
    forM_ lights $ \light -> do
        ...
        return lightsElement #+
            ...
            , UI.div #. "light-tile-abc" #+ [string desc]
